...
return {
  failure_messages = {
    ...
    'ทุกๆครั้งที่ล้มเหลว, ดื่มเบียร์อีกแก้ว',
    'แย่จุงเบย'
  },
  success_messages = {
    'อุ๊ตะ!, สเปคผ่าน!',
